...
public struct _ActorRef<Message: Codable>: @unchecked Sendable, _ReceivesMessages, _DeathWatchable, _ReceivesSystemMessages {
    ...
    public func tell(_ message: Message, file: String = #fileID, line: UInt = #line) {
        switch self.personality {
        case .cell(let cell):
...
public final class _ActorCell<Message: Codable> {
    ...
    @usableFromInline
    func sendMessage(_ message: Message, file: String = #fileID, line: UInt = #line) {
    ...
    func sendSystemMessage(_ message: _SystemMessage, file: String = #fileID, line: UInt = #line) {
    ...
    @usableFromInline
    func sendClosure(file: String = #fileID, line: UInt = #line, _ f: @escaping () throws -> Void) {
    ...
    @usableFromInline
    func sendSubMessage<SubMessage>(_ message: SubMessage, identifier: _AnySubReceiveId, subReceiveAddress: ActorID, file: String = #fileID, line: UInt = #line) {
    ...
    @usableFromInline
    func sendAdaptedMessage(_ message: Any, file: String = #fileID, line: UInt = #line) {
...
open class _CellDelegate<Message: Codable> {
    ...
    open func sendMessage(_ message: Message, file: String = #fileID, line: UInt = #line) {
    ...
    open func sendClosure(file: String = #fileID, line: UInt = #line, _ f: @escaping () throws -> Void) {
        fatalError("Not implemented: \(#function), called from \(file):\(line)")
    }

    open func sendSubMessage<SubMessage>(_ message: SubMessage, identifier: _AnySubReceiveId, subReceiveAddress: ActorID, file: String = #fileID, line: UInt = #line) {
        fatalError("Not implemented: \(#function), called from \(file):\(line)")
    }

    open func sendAdaptedMessage(_ message: Any, file: String = #fileID, line: UInt = #line) {
        fatalError("Not implemented: \(#function), called from \(file):\(line)")
    }
}
...
internal struct TheOneWhoHasNoParent: _ReceivesSystemMessages { // FIXME: fix the name
    ...
    internal func _sendSystemMessage(_ message: _SystemMessage, file: String = #fileID, line: UInt = #line) {
    ...
    @usableFromInline
    internal func _tellOrDeadLetter(_ message: Any, file: String = #fileID, line: UInt = #line) {
        CDistributedActorsMailbox.sact_dump_backtrace()
        fatalError("The \(self.id) actor MUST NOT receive any messages. Yet received \(message); Sent at \(file):\(line)")
    }

    @usableFromInline
    internal func _dropAsDeadLetter(_ message: Any, file: String = #fileID, line: UInt = #line) {
        CDistributedActorsMailbox.sact_dump_backtrace()
        fatalError("The \(self.id) actor MUST NOT receive any messages. Yet received \(message); Sent at \(file):\(line)")
    }
...
public class _Guardian {
    ...
    @usableFromInline
    func trySendUserMessage(_ message: Any, file: String = #fileID, line: UInt = #line) {
