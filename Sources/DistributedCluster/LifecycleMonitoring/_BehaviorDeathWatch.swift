...
internal struct DeathWatchImpl<Message: Codable> {
    ...
    public mutating func receiveNodeTerminated(_ terminatedNode: UniqueNode, myself: _ReceivesSystemMessages) {
        for watched: _AddressableActorRef in self.watching.keys where watched.id.uniqueNode == terminatedNode {
            ...
            myself._sendSystemMessage(.terminated(ref: watched, existenceConfirmed: existenceConfirmed, idTerminated: true), file: #fileID, line: #line)
        }
    }
    ...
    func notifyWatchersWeDied(myself: _ActorRef<Message>) {
        ...
        for watcher in self.watchedBy {
            ...
            watcher._sendSystemMessage(.terminated(ref: _AddressableActorRef(myself), existenceConfirmed: true), file: #fileID, line: #line)
        }
    }
    ...
    private func subscribeNodeTerminatedEvents(myself: _ActorRef<Message>, watchedID: ActorID, file: String = #fileID, line: UInt = #line) {
