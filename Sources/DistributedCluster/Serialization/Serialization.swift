...
extension Serialization {
    ...
    public func _ensureSerializer<Message: Codable>(_ type: Message.Type, file: String = #fileID, line: UInt = #line) throws {
...
public struct SerializationError: Error, CustomStringConvertible {
    ...
    public static func missingSerializationContext(_ coder: Swift.Decoder, _ _type: Any.Type, file: String = #fileID, line: UInt = #line) -> SerializationError {
    ...
    public static func missingSerializationContext(_ coder: Swift.Encoder, _ message: Any, file: String = #fileID, line: UInt = #line) -> SerializationError {
        SerializationError(.missingSerializationContext(
            type(of: message),
            details:
            """
