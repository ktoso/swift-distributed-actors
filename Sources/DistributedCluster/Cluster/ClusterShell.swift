...
internal class ClusterShell {
    ...
    internal func getEnsureAssociation(with node: UniqueNode, file: String = #fileID, line: UInt = #line) -> StoredAssociationState {
        self._associationsLock.withLock {
    ...
    private func completeAssociation(_ associated: ClusterShellState.AssociatedDirective, file: String = #fileID, line: UInt = #line) throws {
