...
public final class _RemoteClusterActorPersonality<Message: Codable> {
    ...
    @usableFromInline
    func sendUserMessage(_ message: Message, file: String = #fileID, line: UInt = #line) {
    ...
    @usableFromInline
    func sendInvocation(_ invocation: InvocationMessage, file: String = #fileID, line: UInt = #line) {
