...
//        self.userMailboxInitCounter.destroy()
    ...
    public func shutdown() throws -> Shutdown {
        ...
        self.log.log(level: .debug, "Shutting down actor system [\(self.name)]. All actors will be stopped.", file: #fileID, function: #function, line: #line)
        defer {
    ...
    public func resignID(_ id: ActorID) {
        ...
        self.namingLock.withLockVoid {
            ...
            if let ref = self._managedRefs.removeValue(forKey: id) {
                ref._sendSystemMessage(.stop, file: #fileID, line: #line)
            }
        }
